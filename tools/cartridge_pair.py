...
"""Pair the two cartridges' copies of the same code and read the delta off every pointer in it.
    ...
    ./.venv/bin/python tools/cartridge_pair.py
    ./.venv/bin/python tools/cartridge_pair.py --names        # the LeafGreen twin of what we name
    ./.venv/bin/python tools/cartridge_pair.py --pair bs121 lg192
