...
[native code](frlg_rom_buffer_script.md)) found `gSpecialVar_0x8000` = 0x020370B4 at bs57, with four
...
load, so that miss is a placement miss like any other. docs/frlg_leafgreen.md has the run.
