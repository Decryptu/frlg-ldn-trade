...
**Brilliant Diamond and Shining Pearl** and **Sword and Shield** are native Switch titles. There is
no ROM and no emulator; Pia is the game's own transport, with Unity/IL2CPP (BDSP) or native C++ with
protobuf messages (Sword/Shield) above it. Both have completed a trade with a retail console.
