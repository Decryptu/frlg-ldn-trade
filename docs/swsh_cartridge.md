---
title: The cartridge and its keys
parent: Sword and Shield
nav_order: 1
---

# Reading a Sword cartridge, and the keys under the game

The static reading: what the title is made of, where its wireless keys come from, and how the
image is opened without unpacking 13 GB.
