...
`docs/frlg_rom_buffer_script.md`). bs18 read EC_GROUP_FEELINGS and was self-verifying the moment it landed:
...
not have to be repeated. See [LeafGreen](frlg_leafgreen.md); use `rom_map.leafgreen_guess`, which knows
